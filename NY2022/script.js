import THREE from "https://cdn.skypack.dev/pin/three@v0.135.0-pjGUcRG9Xt70OdXl97VF/mode=imports,min/optimized/three.js";
import {
  BloomEffect,
  EffectComposer,
  EffectPass,
...
class World {
    ...
    farPlane = 100 })
  {
    ...
    this.scene.background = new THREE.Color("#0d001a");
